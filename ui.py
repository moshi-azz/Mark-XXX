...
class JarvisUI:
    def __init__(self, face_path, size=None):
        ...
        # Input Frame
        self.input_frame = tk.Frame(self.root, bg="#000d12",
                                    highlightbackground=C_DIM,
                                    highlightthickness=1)
        self.input_frame.place(x=(W - LW) // 2, y=H - 32, width=LW, height=28)

        self.input_entry = tk.Entry(self.input_frame, fg=C_TEXT, bg="#000d12",
                                     insertbackground=C_TEXT, borderwidth=0,
                                     font=("Courier", 10))
